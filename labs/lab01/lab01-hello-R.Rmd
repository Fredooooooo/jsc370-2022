...
Go the the the lab page for this week on the [website](https://jsc370.github.io/jsc370-2022/). You can download the lab materials from the course github. 
...
This should tell you what version of R you are currently using. If your R version is lower than 4.0.0 I would strongly recommend updating. In general it is a good idea to update your R version, unless you have a project right now that depend on a specific version of R.
...
There are 1846 rows and 3 variables. Variables are 'dataset', 'x', and 'y'.
...
star_data %>%
  summarize(r = cor(x, y))
```
The correlation coefficient is larger than dino dataset.

Facet by the dataset variable, placing the plots in a 3 column grid, and don't add a legend.

5. Finally, let's plot all datasets at once. In order to do this we will make use of facetting.

```{r all-viz, eval=TRUE, fig.fullwidth=TRUE, fig.height=4, fig.width=4}
...
This set of lab exercises have been adopted from [Mine Çetinkaya-Rundel](https://twitter.com/minebocek)'s class [Introduction to Data Science](https://github.com/ids-s1-19).
